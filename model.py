...
from keras.layers import Input, Conv2D, UpSampling2D, BatchNormalization, ZeroPadding2D, MaxPooling2D, Reshape, Permute, Activation
...
def build_encoder_decoder():
    ...
    x = Conv2D(num_labels, (1, 1), padding='valid', name='deconv0', kernel_initializer='he_normal',
               bias_initializer='zeros')(x)
